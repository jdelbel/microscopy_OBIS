...
emof_lifeStage <- format_obis %>% 
  ...
  pivot_longer(c(measurementValue:lifeStage),
               names_to = "measurementType", values_to = "measurmentValue")
...
occurance_unique <- occurance_unique %>% 
...
write_csv(emof_no_lifeStage, file.path(out_path, "Hakai_phytoplankton_emof_noLs.csv"))
write_csv(emof_lifeStage, file.path(out_path, "Hakai_phytoplankton_emof_ls.csv"))
write_csv(occurance_unique, file.path(out_path, "occurrence_distinct_check.csv"))
```
