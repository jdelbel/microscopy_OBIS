...
```{r}
micro_1 <- read_csv(here("cleaned_csv", "kc10_1.csv"))

micro_2 <- read_csv(here("cleaned_csv", "kc10_2.csv"))
...
write_csv(micro_tidy, here("cleaned_csv", "microscopy_kc10_2021-05-03.csv"))
