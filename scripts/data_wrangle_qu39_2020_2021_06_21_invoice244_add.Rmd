...
micro <- read.csv(here("files", "upload_ qu39_2020_invoice244_additions.csv"), 
                  na.strings = c("","NA"))
...
micro <- micro %>% 
  filter(!group == "Notes") %>% 
  filter_at(vars(QPHY1371:QPHY1454), any_vars(!is.na(.)))
...
write_csv(micro_tidy, here("cleaned_csv", "microscopy_qu39_2020_invoice244_add.csv"))
