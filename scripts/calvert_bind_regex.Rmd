...
```{r}
micro_1 <- read_csv(here("cleaned_csv", "qcs01_1.csv"))

micro_2 <- read_csv(here("cleaned_csv", "qcs01_2.csv"))

micro_3 <- read_csv(here("cleaned_csv", "qcs01_3.csv"))
...
write_csv(micro_tidy, here("cleaned_csv", "microscopy_qcs01_2021-05-03.csv"))
