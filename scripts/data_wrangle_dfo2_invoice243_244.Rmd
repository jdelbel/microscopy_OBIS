...
micro <- read_xlsx(here("files", "Calvert_phyto.xlsx"), sheet = "DFO2_3")
...
micro <- micro %>% 
  filter(!group == "Notes") %>%
  filter_at(vars(CPHY522:CPHY539), any_vars(!is.na(.)))
...
write_csv(micro_tidy, here("cleaned_csv", "dfo2_invoice243-244.csv"))
```
