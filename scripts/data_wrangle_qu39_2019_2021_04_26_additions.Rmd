...
micro <- read.csv(here("files", "upload_qu39_2019_2021_04_26.csv"), na.strings = c("","NA"))
...
micro <- micro %>% 
  filter(!group == "Notes") %>% 
  filter_at(vars(QPHY1299:QPHY1327), any_vars(!is.na(.)))
...
micro <- micro %>% 
  unite("species", species, X, X.1, sep = " ", na.rm = TRUE)
```
...
#Chaetocers debilis resting stg
#Chaetoceros  resting stg
#Ditylum brightwellii spore
...
write_csv(micro_tidy, here("cleaned_csv", "microscopy_qu39_2019_2021_04_26.csv"))
