...
micro <- read_xlsx(here("files", "Calvert_phyto.xlsx"), sheet = "KC10_2")
...
#   unite("analyst_note", Notes_1:Notes_9, sep = " ", na.rm = TRUE)
...
micro <- micro %>% 
  filter(!group == "Notes") %>%
  filter_at(vars(CPHY526:CPHY532), any_vars(!is.na(.)))
...
write_csv(micro_tidy, here("cleaned_csv", "kc10_2.csv"))
```
