...
micro <- read_csv(here("output_worms_matching", "calvert_2018_2020.csv"))
...
micro <- micro %>% 
  select(date, site_id, group, scientificName, AphiaID, 
...
write_csv(micro, here("output_research", "calvert.csv"))
```
...
ggsave(here("figures", "Calvert.png"), width = 17, height = 15, dpi = 300)
...
ggsave(here("figures", "Calvert_diat_species.png"), 
...
ggsave(here("figures", "Calvert_chloro_species.png"), 
        width = 17, height = 15, dpi = 300)
```
...
ggsave(here("figures", "Calvert_chryso_species.png"), 
        width = 17, height = 15, dpi = 300)
```
```{r}
#Cryptophytes
...
ggsave(here("figures", "Calvert_cryto_species.png"), 
        width = 17, height = 15, dpi = 300)
```
...
ggsave(here("figures", "Calvert_dictyo_species.png"), 
        width = 17, height = 15, dpi = 300)
```
```{r}
...
ggsave(here("figures", "Calvert_dinos_species.png"), 
        width = 17, height = 15, dpi = 300)
```
```{r}
#Euglenos
...
ggsave(here("figures", "Calvert_euglenos_species.png"), 
        width = 17, height = 15, dpi = 300)
```
```{r}
#Haptos
...
ggsave(here("figures", "Calvert_haptos_species.png"), 
        width = 17, height = 15, dpi = 300)
```
...
ggsave(here("figures", "Calvert_raphidos_species.png"), 
        width = 17, height = 15, dpi = 300)
```