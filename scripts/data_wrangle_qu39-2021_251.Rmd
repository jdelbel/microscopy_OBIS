...
micro <- read.csv(here("files", "upload_QU39_2021_251.csv"), na.strings = c("","NA"))
...
micro <- micro %>% 
  filter(!group == "Notes") %>% 
  filter_at(vars(QPHY1452:QPHY1493), any_vars(!is.na(.)))
...
metadata <- read_csv(here("files", "qu39_meta_2021.csv"))
...
write_csv(micro_tidy, here("cleaned_csv", "microscopy_qu39_2021_251.csv"))
