...
format_flat <- read_csv(here("output_worms_matching", "qu39_2020.csv"))
```
...
write_csv(format_obis, here("output_obis_format", "OBIS_format_flat_qu39_2020.csv"))
write_csv(event, here("output_obis_format", "Hakai_phytoplankton_event.csv"))
write_csv(occurrence, here("output_obis_format", "Hakai_phytoplankton_occurrence_idRemark_qu39_2020.csv"))
write_csv(emof_no_lifeStage, here("output_obis_format", "Hakai_phytoplankton_emof_no_lifeStage_qu39_2020.csv"))
write_csv(emof_lifeStage, here("output_obis_format", "Hakai_phytoplankton_emof_lifeStage_qu39_2020.csv"))
