...
micro_4 <- read_csv(here("cleaned_csv", "microscopy_qu39_2020_invoice244_add.csv"))

micro_5 <- read_csv(here("cleaned_csv", "microscopy_qu39_2019_invoice245_add.csv"))


micro <- rbind(micro_1, micro_2, micro_3, micro_4, micro_5)
```
...
write_csv(complete_join, here("output_worms_matching", "qu39_2016_2020-Invoice245.csv"))
```
